...
public class levelThree extends AppCompatActivity {
    ...
    int rows = 3;
    int columns = 3;
    int originalColor = 250,fadeColor = 180;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        while(num3!=b.length)
        {
            ...
            while(num4!=b[0].length)
            {
                b[num3][num4].setOnClickListener(new View.OnClickListener() {
                    ...
                    {
                        Intent wrong = new Intent(levelThree.this,levelFour.class);
                        startActivity(wrong);
        ...
        b[fade[0]][fade[1]].setOnClickListener(new View.OnClickListener() {
            ...
            {
                Score.score++;
                Intent changeLevel = new Intent(levelThree.this,levelFour.class);
