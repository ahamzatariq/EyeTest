...
public class levelTwo extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        while(num3!=b.length)
        {
            ...
            while(num4!=b[0].length)
            {
                b[num3][num4].setOnClickListener(new View.OnClickListener() {
                    ...
                    {
                        Intent wrong = new Intent(levelTwo.this,levelThree.class);
                        startActivity(wrong);
        ...
        b[fade[0]][fade[1]].setOnClickListener(new View.OnClickListener() {
            ...
            {
                Score.score++;
                Intent changeLevel = new Intent(levelTwo.this,levelThree.class);
    ...
    public void initialiseAll()
    {
        ...
        fadedColor[0] = Color.argb(200,113,198,113);
        fadedColor[1] = Color.argb(200,142,56,142);
        fadedColor[2] = Color.argb(200,255,64,64);
        fadedColor[3] = Color.argb(200,60,40,10);
        fadedColor[4] = Color.argb(200,238,106,167);
        fadedColor[5] = Color.argb(200,139,71,137);
        fadedColor[6] = Color.argb(200,75,0,130);
        fadedColor[7] = Color.argb(200,100,149,237);
        fadedColor[8] = Color.argb(200,99,184,255);
        fadedColor[9] = Color.argb(200,30,90,150);
        fadedColor[10] = Color.argb(200,128,128,0);
        fadedColor[11] = Color.argb(200,233,150,122);
        fadedColor[12] = Color.argb(200,47,79,79);
        fadedColor[13] = Color.argb(200,124,252,0);
        fadedColor[14] = Color.argb(200,0,255,255);
        fadedColor[15] = Color.argb(200,0,0,255);
        fadedColor[16] = Color.argb(200,255,0,0);
        fadedColor[17] = Color.argb(200,220,20,60);
        fadedColor[18] = Color.argb(200,85,107,47);
        fadedColor[19] = Color.argb(200,0,100,0);
